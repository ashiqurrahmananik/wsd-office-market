  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <form action={createListing} className="card mt-8 grid gap-5 p-7 md:grid-cols-2" encType="multipart/form-data">
        ...
        <div className="md:col-span-2 flex items-center justify-between rounded-2xl border border-dashed border-stone-300 p-4 opacity-60">
          <span className="text-sm font-bold text-stone-500">🔨 Auction / bidding</span>
